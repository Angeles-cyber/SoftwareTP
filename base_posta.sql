...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 29-05-2025 a las 00:24:49
...
INSERT INTO `paciente` (`NombreApe`, `TipoDocumento`, `NumDocumento`, `FechaNacimiento`, `Celular`, `Correo`, `TipoSeguro`, `Contraseña`) VALUES
('Angeles Mendoza Luis del Piero', 'DNI', 71418624, '20 de Julio 2004', 987709074, 'luisangeles@gmail.com', 'SIS', '203006'),
('Milagros Gonzales Andres', 'DNI', 61801571, '22 de enero 2004', 913850263, 'gonzalesmilagros258@gmail.com', 'SIS', '220104'),
('Jarol Arriea', 'DNI', 71427186, '05/09/2004', 967743623, 'srrietaramirezjarol9', 'SIS', '123456789');
...
--
-- Volcado de datos para la tabla `usuariodoc`
--

INSERT INTO `usuariodoc` (`Nombre`, `Contraseña`, `Tipo_doc`, `Correo`) VALUES
('Diego Ferna', 'Fernandez', '74316239', 'fernandes@g');
COMMIT;
